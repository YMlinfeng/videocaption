...
/data/tpj/tpj/caffe-master-20160829/caffe-master/build/tools/caffe train \
    -solver /data/tpj/Sentivideo_v2_20190910/FT_combine/s2vt_test7_resnet_coco_pre_factor3_2stream3_pre_train_all_2stage/s2vt_solver.prototxt \
    -weights /data/tpj/Sentivideo_v2_20190910/FT_combine/s2vt_test7_resnet_coco_pre_factor3_2stream3_pre_train_all_2stage/s2vt_sentivideo_resnet152_iter_300000.caffemodel
    -gpu $GPU_ID
