  ...
  def get_streams(self):
    ...
    if pad < 0:
      ...
      if (num_words + 1) > self.max_words:
        ...
        stream = stream[:10] # truncate words to 10                          ###tpj
...
VOCAB = '/home/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt/Youtube/vocabulary.txt'
OUTPUT_DIR_PATTERN = '%s/%%s_batches' % OUTPUT_DIR
#FRAMEFEAT_FILE_PATTERN = './youtube/splits/yt_allframes_vgg_fc7_{0}.txt'
FRAMEFEAT_FILE_PATTERN = '/home/tpj/tpj/S2VT/videocap-datasets/Youtube/splits/yt_allframes_vgg_fc7_{0}.txt'
#SENTS_FILE_PATTERN = './youtube/splits/sents_{0}_lc_nopunc.txt'
SENTS_FILE_PATTERN = '/home/tpj/tpj/S2VT/videocap-datasets/Youtube/youtube_auxfile/sents_{0}_lc_nopunc.txt'
#OUT_FILE_PATTERN = './rawcorpus/{0}/s2vt_vgg_{0}_sequence.txt'
OUT_FILE_PATTERN = '/home/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt/Youtube/val/s2vt_vgg_{0}_sequence.txt'
#OUT_CORPUS_PATH = './rawcorpus/{0}'
OUT_CORPUS_PATH = '/home/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt/Youtube/val'
