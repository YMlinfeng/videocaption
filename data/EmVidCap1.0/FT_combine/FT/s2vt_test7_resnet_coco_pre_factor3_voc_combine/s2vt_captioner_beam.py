...
def predict_image_caption_beam_search(net, video_feature, pad_img_feature, vocab_list, strategy, max_length=50):
  ...
  while beams_complete < len(beams):
    ...
    for beam_index, beam_log_prob, beam in \
      ...
      #print probs.shape[0]               ###tpj
      #print len(vocab_list)              ###tpj
...
def main():
  ...
  #DIR = './snapshots'
  #DIR = '/data/tpj/sentivideo_v2/FT/s2vt_test7_resnet_coco_pre_factor/models'
  #VOCAB_FILE = './yt_coco_mvad_mpiimd_vocabulary.txt'
  #VOCAB_FILE = '/data/tpj/sentivideo_v2/FT/vocabulary.txt'
  #FRAMEFEAT_FILE_PATTERN = './yt_allframes_vgg_fc7_{0}.txt'
  #FRAMEFEAT_FILE_PATTERN = '/data/tpj/sentivideo_v2/senti_dataset/features_per5/features_resnet152_coco_pre/sentivideo_allframes_resnet152_pool5_coco_pre_{0}.txt'
 
  #LSTM_NET_FILE = './s2vt.words_to_preds.deploy.prototxt'
  #LSTM_NET_FILE = '/data/tpj/sentivideo_v2/FT/s2vt_test7_resnet_coco_pre_factor/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  #RESULTS_DIR = '/data/tpj/sentivideo_v2/FT/s2vt_test7_resnet_coco_pre_factor/results'

  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine/s2vt_test7_resnet_coco_pre_factor3_voc_combine/models'
  #VOCAB_FILE = './yt_coco_mvad_mpiimd_vocabulary.txt'
  ...
  #LSTM_NET_FILE = './s2vt.words_to_preds.deploy.prototxt'
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_combine/s2vt_test7_resnet_coco_pre_factor3_voc_combine/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine/s2vt_test7_resnet_coco_pre_factor3_voc_combine/results'
