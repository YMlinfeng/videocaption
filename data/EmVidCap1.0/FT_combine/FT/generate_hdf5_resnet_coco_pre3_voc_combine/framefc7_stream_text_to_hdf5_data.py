  ...
  def get_streams(self):
    ...
    if pad < 0:
      ...
      if (num_words + 1) > self.max_words:
        stream = stream[:30] # truncate words to 20
...
#SETTING = '.'
SETTING = '/data/tpj/Sentivideo_v2_20190910/FT_combine/generate_hdf5_resnet_coco_pre3_voc_combine'
...
OUT_FILE_PATTERN = '/data/tpj/Sentivideo_v2_20190910/FT_combine/generate_hdf5_resnet_coco_pre/val/s2vt_resnet152_{0}_sequence.txt'
#OUT_CORPUS_PATH = './rawcorpus/{0}'
OUT_CORPUS_PATH = '/data/tpj/Sentivideo_v2_20190910/FT_combine/generate_hdf5_resnet_coco_pre/val'
