...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/sentivideo_v2/FT/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream3/models'
  #VOCAB_FILE = './yt_coco_mvad_mpiimd_vocabulary.txt'
  VOCAB_FILE = '/data/tpj/sentivideo_v2/FT/vocabulary_combine_sorted.txt'
  ...
  LSTM_NET_FILE = '/data/tpj/sentivideo_v2/FT/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream3/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/sentivideo_v2/FT/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream3/results'
