...
original_split='/data/tpj/tpj/S2VT/videocap-datasets/Youtube_senti/splits_pre_train/';
...
fidtrain=fopen([original_split,'train.txt'],'w');
%fidval=fopen([original_split,'val.txt'],'w');
fidtest=fopen([original_split,'test.txt'],'w');
