...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Glove/lf_resnet_coco_pre_factor_senti/models'
  ...
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Glove/lf_resnet_coco_pre_factor_senti/deploy_lm_deepfus_img512_s2vt_glove.words_to_preds.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Glove/lf_resnet_coco_pre_factor_senti/results'
