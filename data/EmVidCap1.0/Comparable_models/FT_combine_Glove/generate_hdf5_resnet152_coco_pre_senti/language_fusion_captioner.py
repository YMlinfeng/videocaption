...
CAFFE_PATH='/data/tpj/tpj/caffe-recurrent-20180518/caffe-recurrent/python/'
...
def main():
  ...
  DIR = '/data/tpj/tpj/caffe-recurrent-20180518/caffe-recurrent/examples/language_fusion/lf_resnet_coco_pre/models'
  VOCAB_FILE = '/data/tpj/tpj/caffe-recurrent-20180518/caffe-recurrent/examples/language_fusion/lf_tools/vocabulary.txt'
  FRAMEFEAT_FILE_PATTERN = '/data/tpj/tpj/S2VT/videocap-datasets/Youtube/splits/features_resnet_coco_pre/yt_allframes_resnet_pool5_coco_pre_val.txt'

  LSTM_NET_FILE = args.netdeploy
#  RESULTS_DIR = './results/s2vt_glove'
  RESULTS_DIR = '/data/tpj/tpj/caffe-recurrent-20180518/caffe-recurrent/examples/language_fusion/lf_resnet_coco_pre/results'
