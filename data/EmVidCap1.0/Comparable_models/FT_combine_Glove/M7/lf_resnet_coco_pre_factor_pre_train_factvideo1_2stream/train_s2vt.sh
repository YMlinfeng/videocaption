...
/data/tpj/tpj/caffe-master-20160829/caffe-master/build/tools/caffe train \
    -solver /data/tpj/Sentivideo_v2_20190910/FT_combine_Glove/M7/lf_resnet_coco_pre_factor_pre_train_factvideo1_2stream/solver_cocolm_deepfus_img512_s2vt_glove.prototxt \
    -gpu $GPU_ID
