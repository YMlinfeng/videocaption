...
def predict_single_word(net, pad_img_feature, previous_word, output1='probs', output2='probs_senti'):
  ...
  output_preds = 0*output_preds1 + 1*output_preds2       ###tpj
  return output_preds
...
def sample_captions(net, image_features,
  ...
  while num_done < batch_size:
    ...
    net_output_probs = 0*net_output_probs1 + 1*net_output_probs2           ###tpj
    for index in range(batch_size):
...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Glove/lf_resnet_coco_pre_factor_pre_train_factvideo1_2stream3/models'
  ...
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Glove/lf_resnet_coco_pre_factor_pre_train_factvideo1_2stream3/deploy_lm_deepfus_img512_s2vt_glove.words_to_preds.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Glove/lf_resnet_coco_pre_factor_pre_train_factvideo1_2stream3/results_01'
