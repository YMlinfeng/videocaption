...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream3/models2'
  ...
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream3/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream3/results2_82'
