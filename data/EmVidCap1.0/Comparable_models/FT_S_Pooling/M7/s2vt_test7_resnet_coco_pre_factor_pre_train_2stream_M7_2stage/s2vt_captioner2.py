...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/M7/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream_M7_2stage/models'
  ...
  FRAMEFEAT_FILE_PATTERN = '/data/tpj/Sentivideo_v2_20190910/dataset/extract_features/extract_feature_resnet152_coco_pre_senti_s_poolingall/test/youtube_allframes_resnet_pool5_coco_pre_{0}.txt'
 
  #LSTM_NET_FILE = './s2vt.words_to_preds.deploy.prototxt'
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/M7/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream_M7_2stage/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/M7/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream_M7_2stage/results_55'
