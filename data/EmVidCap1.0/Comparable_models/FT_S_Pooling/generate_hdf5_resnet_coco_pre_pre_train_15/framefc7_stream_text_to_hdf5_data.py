...
SETTING = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/generate_hdf5_resnet_coco_pre_pre_train_15'
OUTPUT_DIR = '{0}/hdf5/buffer_{1}_s2vt_{2}'.format(SETTING, BUFFER_SIZE, MAX_WORDS)
#VOCAB = '%s/vocabulary.txt' % SETTING
VOCAB = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/vocabulary_refine.txt'
OUTPUT_DIR_PATTERN = '%s/%%s_batches' % OUTPUT_DIR
#FRAMEFEAT_FILE_PATTERN = './youtube/splits/yt_allframes_vgg_fc7_{0}.txt'
FRAMEFEAT_FILE_PATTERN = '/data/tpj/Sentivideo_v2_20190910/dataset/extract_features/extract_feature_resnet152_coco_pre_factvideo2_poolingall/train/youtube_allframes_resnet_pool5_coco_pre_{0}.txt'
#SENTS_FILE_PATTERN = './youtube/splits/sents_{0}_lc_nopunc.txt'
SENTS_FILE_PATTERN = '/data/tpj/tpj/S2VT/videocap-datasets/Youtube_senti/splits_pre_train_15/sent_{0}_pre_train_15.txt'
