...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_senti/models'
  ...
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_senti/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_senti/results'
