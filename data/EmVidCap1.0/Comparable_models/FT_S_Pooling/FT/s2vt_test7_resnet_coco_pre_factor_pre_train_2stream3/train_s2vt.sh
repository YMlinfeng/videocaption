...
/data/tpj/tpj/caffe-master-20160829/caffe-master/build/tools/caffe train \
    -solver /data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream3/s2vt_solver.prototxt \
    -weights /data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream3/s2vt_youtube_resnet_iter_200000.caffemodel
    -gpu $GPU_ID
