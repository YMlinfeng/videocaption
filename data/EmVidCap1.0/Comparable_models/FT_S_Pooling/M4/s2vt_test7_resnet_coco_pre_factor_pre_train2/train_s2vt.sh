...
/data/tpj/tpj/caffe-master-20160829/caffe-master/build/tools/caffe train \
    -solver /data/tpj/Sentivideo_v2_20190910/FT_S_Pooling/s2vt_test7_resnet_coco_pre_factor_pre_train2/s2vt_solver.prototxt \
    #-weights /data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream/s2vt_youtube_resnet_iter_140000.caffemodel
    -gpu $GPU_ID
