...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/s2vt_test7_resnet_coco_pre_factor_pre_train2/models'
  ...
  FRAMEFEAT_FILE_PATTERN = '/data/tpj/tpj/S2VT/videocap-datasets/Youtube_senti/splits_pre_train/features/features_resnet_coco_pre/youtube_allframes_resnet_pool5_coco_pre_{0}.txt'
 
  #LSTM_NET_FILE = './s2vt.words_to_preds.deploy.prototxt'
  LSTM_NET_FILE = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/s2vt_test7_resnet_coco_pre_factor_pre_train2/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/s2vt_test7_resnet_coco_pre_factor_pre_train2/results'
