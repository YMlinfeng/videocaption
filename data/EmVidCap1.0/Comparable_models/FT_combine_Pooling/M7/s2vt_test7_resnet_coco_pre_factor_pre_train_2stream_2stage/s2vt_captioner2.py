...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Pooling/M7/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream_2stage/models'
  ...
  FRAMEFEAT_FILE_PATTERN = '/data/tpj/Sentivideo_v2_20190910/dataset_combine/extract_features/extract_feature_resnet152_coco_pre_poolingall/test/sentivideo_allframes_resnet152_pool5_coco_pre_{0}_senti.txt'
 
  #LSTM_NET_FILE = './s2vt.words_to_preds.deploy.prototxt'
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Pooling/M7/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream_2stage/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Pooling/M7/s2vt_test7_resnet_coco_pre_factor_pre_train_2stream_2stage/results_55'
  ...
  for split_name, data_split_name, aligned in DATASETS:
    ...
    for c in range(START_CHUNK, NUM_CHUNKS):
      ...
      for strat_type in text_out_types:
        text_out_fname = text_out_filename + strat_type + '_time_test.txt'
