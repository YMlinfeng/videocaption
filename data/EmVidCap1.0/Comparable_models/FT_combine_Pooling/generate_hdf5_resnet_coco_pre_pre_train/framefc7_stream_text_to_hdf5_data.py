...
SETTING = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Pooling/generate_hdf5_resnet_coco_pre_pre_train'
...
FRAMEFEAT_FILE_PATTERN = '/data/tpj/Sentivideo_v2_20190910/dataset/extract_features/extract_feature_resnet152_coco_pre_factvideo1_poolingall/train/youtube_allframes_resnet_pool5_coco_pre_{0}.txt'
#SENTS_FILE_PATTERN = './youtube/splits/sents_{0}_lc_nopunc.txt'
SENTS_FILE_PATTERN = '/data/tpj/tpj/S2VT/videocap-datasets/Youtube_senti/splits_pre_train/sent_{0}_pre_train.txt'
