...
SETTING = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Pooling/generate_hdf5_resnet_coco_pre_pre_train_senti'
OUTPUT_DIR = '{0}/hdf5/buffer_{1}_s2vt_{2}'.format(SETTING, BUFFER_SIZE, MAX_WORDS)
#VOCAB = '%s/vocabulary.txt' % SETTING
VOCAB = '/data/tpj/Sentivideo_v2_20190910/dataset_combine/vocabulary_threshold_1_combine_sorted.txt'
...
SENTS_FILE_PATTERN = '/data/tpj/Sentivideo_v2_20190910/dataset_combine/references_{0}_combine.txt'
#OUT_FILE_PATTERN = './rawcorpus/{0}/s2vt_vgg_{0}_sequence.txt'
OUT_FILE_PATTERN = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/generate_hdf5_resnet_coco_pre_pre_train/val/s2vt_resnet_{0}_sequence.txt'
#OUT_CORPUS_PATH = './rawcorpus/{0}'
OUT_CORPUS_PATH = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/generate_hdf5_resnet_coco_pre_pre_train/val'
...
def preprocess_dataset(split_name, data_split_name, batch_stream_length,
  ...
  vid_id_order_outpath = '%s/yt_s2vtresnet_%s_vidid_order_%d_%d.txt' % \
  (out_path, data_split_name, BUFFER_SIZE, MAX_WORDS)
  frame_sequence_outpath = '%s/yt_s2vtresnet_%s_sequence_%d_%d_recurrent.txt' % \
  (out_path, data_split_name, BUFFER_SIZE, MAX_WORDS)
