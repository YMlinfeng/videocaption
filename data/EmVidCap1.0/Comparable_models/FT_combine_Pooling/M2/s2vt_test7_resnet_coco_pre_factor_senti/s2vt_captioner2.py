...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Pooling/s2vt_test7_resnet_coco_pre_factor_senti/models'
  ...
  FRAMEFEAT_FILE_PATTERN = '/data/tpj/Sentivideo_v2_20190910/dataset_combine/extract_features/extract_feature_resnet152_coco_pre_poolingall/train/sentivideo_allframes_resnet152_pool5_coco_pre_{0}_senti.txt'
 
  #LSTM_NET_FILE = './s2vt.words_to_preds.deploy.prototxt'
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Pooling/s2vt_test7_resnet_coco_pre_factor_senti/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_combine_Pooling/s2vt_test7_resnet_coco_pre_factor_senti/results'
