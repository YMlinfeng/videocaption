...
/data/tpj/tpj/caffe-master-20160829/caffe-master/build/tools/caffe train \
    -solver /data/tpj/Sentivideo_v2_20190910/FT_S_Glove/lf_resnet_coco_pre_factor_pre_train_senti/solver_cocolm_deepfus_img512_s2vt_glove.prototxt \
    -weights /data/tpj/Sentivideo_v2_20190910/FT_S_Glove/lf_resnet_coco_pre_factor_pre_train_senti/lf_resnet_iter_200000.caffemodel
    -gpu $GPU_ID
