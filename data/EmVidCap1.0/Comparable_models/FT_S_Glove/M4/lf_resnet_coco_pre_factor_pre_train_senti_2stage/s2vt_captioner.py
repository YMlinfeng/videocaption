...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/Sentivideo_v2_20190910/FT_S_Glove/M4/lf_resnet_coco_pre_factor_pre_train_senti_2stage/models2'
  ...
  LSTM_NET_FILE = '/data/tpj/Sentivideo_v2_20190910/FT_S_Glove/M4/lf_resnet_coco_pre_factor_pre_train_senti_2stage/deploy_lm_deepfus_img512_s2vt_glove.words_to_preds.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/Sentivideo_v2_20190910/FT_S_Glove/M4/lf_resnet_coco_pre_factor_pre_train_senti_2stage/results2'
