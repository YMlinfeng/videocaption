...
def main():
  ...
  #DIR = './snapshots'
  DIR = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/s2vt_test7_resnet_coco_pre_factor_pre_train/models'
  ...
  LSTM_NET_FILE = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/s2vt_test7_resnet_coco_pre_factor_pre_train/s2vt.words_to_preds.deploy.prototxt'
  #RESULTS_DIR = './results'
  RESULTS_DIR = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/s2vt_test7_resnet_coco_pre_factor_pre_train/results_134'
