...
OUT_FILE_PATTERN = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/generate_hdf5_resnet_coco_pre/val/s2vt_resnet_{0}_sequence.txt'
#OUT_CORPUS_PATH = './rawcorpus/{0}'
OUT_CORPUS_PATH = '/data/tpj/tpj/S2VT/caffe-recurrent/examples/s2vt_senti/generate_hdf5_resnet_coco_pre/val'
