...
class MSVDVocab(CustomVocab):
    ...
    def load_captions(self):
        ...
        df_s = pd.read_csv('data/EmVidCap-S/EmVideo_trainval_captions.csv')

        style_s = df_s['EmCaptions'].values

        # df_l = pd.read_csv('data/EmVideo-L/EmVideo_trainval_captions.csv','\t')
        # df_l = pd.read_csv('data/EmVidCap-L/EmVideo_trainval_captions.csv','\t')
        df_l = pd.read_csv('data/EmVidCap-L/EmVideo_trainval_captions.csv', sep='\t')
